...
import 'modal_ver_atestado_model.dart';
export 'modal_ver_atestado_model.dart';
...
class _ModalVerAtestadoWidgetState extends State<ModalVerAtestadoWidget> {
  late ModalVerAtestadoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalVerAtestadoModel());
