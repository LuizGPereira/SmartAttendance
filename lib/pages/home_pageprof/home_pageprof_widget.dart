                    ...
                    child: Container(
                      ...
                      child: FutureBuilder<List<TurmasRow>>(
                        future: (_model.requestCompleter ??=
                                Completer<List<TurmasRow>>()
                                  ..complete(TurmasTable().queryRows(
                                    queryFn: (q) => q.order('Nometurma'),
                                    limit: 4,
                                  )))
                            .future,
                        builder: (context, snapshot) {
                          ...
                          List<TurmasRow> listViewTurmasRowList =
                              snapshot.data!;
                          return InkWell(
                            ...
                            child: ListView.separated(
                              ...
                              itemCount: listViewTurmasRowList.length,
