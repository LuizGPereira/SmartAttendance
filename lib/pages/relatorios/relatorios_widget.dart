...
class RelatoriosWidget extends StatefulWidget {
  const RelatoriosWidget({Key? key}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: 'Por favor, escreva o nome aqui',
                ...
                child: Row(
                  ...
                  children: [
                    Theme(
                      ...
                      child: Checkbox(
                        value: _model.checkboxAlunoValue ??= false,
                        onChanged: (newValue) async {
                          setState(() => _model.checkboxAlunoValue = newValue!);
                        },
                        activeColor: FlutterFlowTheme.of(context).primary,
                        checkColor: FlutterFlowTheme.of(context).info,
                      ),
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Deseja apenas de um aluno específico ?',
                        style: FlutterFlowTheme.of(context).bodyMedium,
                      ),
                    ),
                  ],
              ...
              Row(
                mainAxisSize: MainAxisSize.max,
                children: [
                  if (_model.checkboxAlunoValue == true)
                    Expanded(
                      child: Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(5.0, 0.0, 5.0, 0.0),
                        child: FlutterFlowDropDown<String>(
                          ...
                          height: 50.0,
                          textStyle: FlutterFlowTheme.of(context).bodyMedium,
                          hintText: 'Por favor, selecione o aluno',
                          icon: Icon(
                            Icons.keyboard_arrow_down_rounded,
                            color: FlutterFlowTheme.of(context).secondaryText,
                            size: 24.0,
