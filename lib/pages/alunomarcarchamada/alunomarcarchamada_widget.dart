...
import 'alunomarcarchamada_model.dart';
export 'alunomarcarchamada_model.dart';

class AlunomarcarchamadaWidget extends StatefulWidget {
  const AlunomarcarchamadaWidget({
    Key? key,
  ...
  @override
  _AlunomarcarchamadaWidgetState createState() =>
      _AlunomarcarchamadaWidgetState();
}

class _AlunomarcarchamadaWidgetState extends State<AlunomarcarchamadaWidget> {
  late AlunomarcarchamadaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AlunomarcarchamadaModel());
