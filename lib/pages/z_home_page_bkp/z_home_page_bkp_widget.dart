...
import 'z_home_page_bkp_model.dart';
export 'z_home_page_bkp_model.dart';

class ZHomePageBkpWidget extends StatefulWidget {
  const ZHomePageBkpWidget({
    Key? key,
    String? pusertype,
    String? puserid,
  ...
  @override
  _ZHomePageBkpWidgetState createState() => _ZHomePageBkpWidgetState();
}

class _ZHomePageBkpWidgetState extends State<ZHomePageBkpWidget> {
  late ZHomePageBkpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ZHomePageBkpModel());
                                              ...
                                              child: GestureDetector(
                                                onTap: () => _model.unfocusNode
                                                    ...
                                                    : FocusScope.of(context)
                                                        .unfocus(),
                                                child:
                                                    ZModalGerarCodigoPresencaWidget(),
                                              ),
                                            );
                                          },
                                        ).then((value) => setState(() {}));
                    ...
                    Column(
                      ...
                      children: [
                        FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            context.pushNamed('zInserirTurma');
                          },
                        ),
                        Text(
                          'Inserir Turma',
                                      ...
                                      return Material(
                                        ...
                                        child: GestureDetector(
                                          onTap: () => _model
                                              ...
                                              : FocusScope.of(context)
                                                  .unfocus(),
                                          child: ZModalPedirAcessoTurmaWidget(
