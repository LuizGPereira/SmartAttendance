...
import 'authen_bkp_model.dart';
export 'authen_bkp_model.dart';

class AuthenBkpWidget extends StatefulWidget {
  const AuthenBkpWidget({
    Key? key,
    this.isprof,
  }) : super(key: key);
  ...
  @override
  _AuthenBkpWidgetState createState() => _AuthenBkpWidgetState();
}

class _AuthenBkpWidgetState extends State<AuthenBkpWidget>
    with TickerProviderStateMixin {
  late AuthenBkpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthenBkpModel());
